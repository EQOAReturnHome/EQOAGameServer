...
namespace ReturnHome.Opcodes
{
    public static class ProcessOpcode
    {
        ...
        /*Might be a better place for this somewhere but for now...
         */
        public static void TargetInformation(Session MySession, uint Target)
        {
            Entity ent;
            //If false, ignore? Might need some kind of escalation, why would we target something not known about?
            //If true, prep message
            if(EntityManager.QueryForEntity(Target, out ent))
            {
                ...
                if (ent.isPlayer)
                {
                    ...
                    message = new byte[] { ,
                    ...
                    temp.Write((byte)3, ref offset);
                    temp.Write((byte)2, ref offset);

                    offset = 124;
                    temp.Write(MySession.MyCharacter.ObjectID, ref offset);

                    offset = 261;
                    temp.Write(MySession.MyCharacter.TargetCounter++, ref offset);
                }

                else
                {
                    //This message type seems to always be this length from live packet captures?
                    message = new byte[] { ,
                    ...
                    Span<byte> temp = message.Span;
                    temp.Write((ushort)GameOpcode.TargetInformation, ref offset);
                    temp.Write((byte)1, ref offset); // 0/1 = red face 2/3 = neutral face 4/5 = blue face
                    temp.Write((byte)0, ref offset); // 0 = red con 1 = yellow con 2 = white con 3 = Dark Blue con 4 = Light Blue Con 5 = Green con 6 = Yellowish/white con? 7 = no con at all? But can still target? 14 = faded yellow con? 15 = faded orange con? 60 = yellowish/green con?

                    offset = 124;
                    temp.Write(MySession.MyCharacter.Target, ref offset);
