...
if (GetPlayerFlags(mySession, "30113") == "2") then
if (CheckQuestItem(mySession, items.BAG_OF_COINS, 1))
 then
if (choice:find("just")) then
npcDialogue = "Duminven: Take a look around... I don't think there is anything for you here...is there?"
...
ContinueQuest(mySession, 30113, quests[30113][2].log)
TurnInItem(mySession, items.NOTE_FROM_WILKINSON, 1)
else
    npcDialogue = "What business would the likes of you possibly have here?"
    diagOptions = { "I have this note...", "I am just here for the view." }
...
elseif (GetPlayerFlags(mySession, "30113") == "3") then
if (CheckQuestItem(mySession, items.MARK_OF_LOUHMANTA, 1)
and CheckQuestItem(mySession, items.CRACKED_RED_CRYSTAL, 1))
 then
if (choice:find("I\'ll")) then
npcDialogue = "Duminven: Take a look around... I'll need Eliene's belongings before I send you back to Malethai Crimsonhand."
elseif (choice:find("these")) then
multiDialogue = { "Duminven: I see that Malethai is selecting better shadowknight's these days. You have done well here. The last shadowknight didn't fare so well after I threw him off the cliff.",
    "Duminven: It seems as though you've prevented a timely misfortune for the Shining Shield Mercenaries. Those thieves were after something much bigger from the sounds of it.",
    "Duminven: I will be retaining the cracked red crystal for my payment. Malethai will want the Mark of Louhmanta. We are finished here.",
"You have given away a cracked red crystal.",
    "You have finished a quest!",
    "You have received a quest!"
}
ContinueQuest(mySession, 30113, quests[30113][3].log)
TurnInItem(mySession, items.CRACKED_RED_CRYSTAL, 1)
else
    npcDialogue = "Failing to retrieve Eliene's belongings would mean severe punishment. What do you report?"
    diagOptions = { "The task is done. I have these...", "I'll be right back." }
...
if (GetPlayerFlags(mySession, "130113") == "2") then
if (CheckQuestItem(mySession, items.BAG_OF_COINS, 1))
 then
if (choice:find("just")) then
npcDialogue = "Duminven: Take a look around... I don't think there is anything for you here...is there?"
...
ContinueQuest(mySession, 130113, quests[130113][2].log)
TurnInItem(mySession, items.NOTE_FROM_WILKINSON, 1)
else
    npcDialogue = "What business would the likes of you possibly have here?"
    diagOptions = { "I have this note...", "I am just here for the view." }
...
elseif (GetPlayerFlags(mySession, "130113") == "3") then
if (CheckQuestItem(mySession, items.MARK_OF_LOUHMANTA, 1)
and CheckQuestItem(mySession, items.CRACKED_RED_CRYSTAL, 1))
 then
if (choice:find("I\'ll")) then
npcDialogue = "Duminven: Take a look around... I'll need Eliene's belongings before I send you back to Sivrendesh."
elseif (choice:find("these")) then
multiDialogue = { "Duminven: I see that Sivrendesh is selecting better wizards these days. You have done well here. The last wizard didn't fare so well after I threw him off the cliff.",
    "Duminven: It seems as though you've prevented a timely misfortune for the Academy of Arcane Science. Those thieves were after something much bigger from the sounds of it.",
    "Duminven: I will be retaining the cracked red crystal for my payment. Sivrendesh will want the Mark of Louhmanta. We are finished here.",
"You have given away a cracked red crystal.",
    "You have finished a quest!",
    "You have received a quest!"
}
ContinueQuest(mySession, 130113, quests[130113][3].log)
TurnInItem(mySession, items.CRACKED_RED_CRYSTAL, 1)
else
    npcDialogue = "Failing to retrieve Eliene's belongings would mean severe punishment. What do you report?"
    diagOptions = { "The task is done. I have these...", "I'll be right back." }
