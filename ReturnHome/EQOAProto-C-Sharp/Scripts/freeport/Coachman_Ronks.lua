...
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
multiDialogue = { "Coachman Ronks: Oh....from Spiritmaster Zole. You know, I'm getting sick and tired of th....well, nevermind.",
...
if (GetPlayerFlags(mySession, "30102") == "2") then
if (choice:find("Nothing")) then
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
multiDialogue = { "Coachman Ronks: Oh....from Spiritmaster Keika. You know, I'm getting sick and tired of th....well, nevermind.",
    "Coachman Ronks: Apparently, it is my duty as a citizen of this \"fine\" city to add you to the stable ledger.",
    "Coachman Ronks: This means that if you find yourself in a nearby city, you can visit the stable there and pay for a ride to Freeport.",
    "Coachman Ronks: Without that record, they cannot offer you passage. If you do, then one of their horses will take you to your destination.",
    "Coachman Ronks: All you need to do is talk to the coachman of the stable and he will add you to his ledger. I'll add you to mine now.",
...
if (GetPlayerFlags(mySession, "50102") == "2") then
if (choice:find("Nothing")) then
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
multiDialogue = { "Coachman Ronks: Oh....from Spiritmaster Imaryn. You know, I'm getting sick and tired of th....well, nevermind.",
    "Coachman Ronks: Apparently, it is my duty as a citizen of this \"fine\" city to add you to the stable ledger.",
    "Coachman Ronks: This means that if you find yourself in a nearby city, you can visit the stable there and pay for a ride to Freeport.",
    "Coachman Ronks: Without that record, they cannot offer you passage. If you do, then one of their horses will take you to your destination.",
    "Coachman Ronks: All you need to do is talk to the coachman of the stable and he will add you to his ledger. I'll add you to mine now.",
...
if (GetPlayerFlags(mySession, "60102") == "2") then
if (choice:find("Nothing")) then
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
...
if (GetPlayerFlags(mySession, "90102") == "2") then
if (choice:find("Nothing")) then
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
...
if (GetPlayerFlags(mySession, "120102") == "2") then
if (choice:find("Nothing")) then
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
...
if (GetPlayerFlags(mySession, "130102") == "2") then
if (choice:find("Nothing")) then
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
...
if (GetPlayerFlags(mySession, "140102") == "2") then
if (choice:find("Nothing")) then
multiDialogue = { "Coachman Ronks: Well don't just stand around here, I have work to do!"
 } 
elseif (choice:find("Spiritmaster")) then
