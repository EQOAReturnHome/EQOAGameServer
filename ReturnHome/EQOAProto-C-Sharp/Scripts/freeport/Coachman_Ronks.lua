...
function event_say(choice)
    ...
    elseif (GetPlayerFlags(mySession, "freeport_coach") == "true" or GetPlayerFlags(mySession, "admin") == "true") then
        ...
        elseif (choice:find("Neriak")) then
            ...
            if next(diagOptions) == nil then
            npcDialogue = "It appears you have not signed any other coachman\'s ledgers. Strike out and sign other town\'s ledgers to be able to use our services."
             end
