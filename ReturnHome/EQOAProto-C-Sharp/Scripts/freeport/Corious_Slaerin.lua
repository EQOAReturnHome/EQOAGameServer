...
multiDialogue = { "Corious Slaerin: You couldn't possibly know that, until you've seen with your own eyes the power of raising the dead to life with your own will.",
...
if (CheckQuestItem(mySession, items.BONE_EARRING, 1))
 then
if (choice:find("Please")) then
npcDialogue = "Corious Slaerin: I'll need you to purchase the bone earring from Merchant Gilgash, then return to me."
elseif (choice:find("earring")) then
multiDialogue = { "Corious Slaerin: Death could call for you at any moment. We are going to have to test your wit and your will, if you wish to extend your life...",
...
multiDialogue = { "Corious Slaerin: You'll find that we guildmasters don't like to be kept waiting. I suggest you tend to the task at hand. Consult your quest log if you have lost track of your tasks."
 } 
...
multiDialogue = { "Corious Slaerin: Do you think you can trick me with such a lie? I am leagues beyond you, playerName. I can see the tendrils of darkness swirl around you. I know where it leads, and I can change it at will."
 } 
elseif (choice:find("master")) then
multiDialogue = { "Corious Slaerin: I have a task that needs attention but I am preoccupied at the moment.",
...
npcDialogue ="Corious Slaerin: Your power is too weak for my uses. Do not return to until you have grown stronger."
end
...
npcDialogue = "Corious Slaerin: The last necromancer to disappoint me was turned to one of my pets. Shall I demonstrate this on you? Bring me the cracked symbol of Tunare. You will find it on Janxt in Temby."
elseif (choice:find("right")) then
multiDialogue = { "Corious Slaerin: You have taken out this Elf already? I must say, I am quite impressed.",
...
multiDialogue = { "Corious Slaerin: There will be plenty of time to rest when the gods have forsaken you, and have chosen not to bring you back to where your spirit was bound. There, in the void you will obtain all the rest you crave."
 } 
elseif (choice:find("ready")) then
multiDialogue = { "Corious Slaerin: A precious item of mine was stolen from my courier. I have already recovered it, but I want the thief to pay for his insolence.",
...
npcDialogue ="Corious Slaerin: You are almost strong enough for this next task, but not quite. Please return to me after you have practiced your skills a bit further."
end
elseif (GetPlayerFlags(mySession, "110110") == "1") then
if (CheckQuestItem(mySession, items.WARM_HEART, 1))
 then
if (choice:find("myself")) then
npcDialogue = "Corious Slaerin: If your will is too weak I shall just  make you my next ritual sacrifice! Return to me with Charlik Novandear's warm heart and I will consider forgiving you."
elseif (choice:find("difficult")) then
multiDialogue = { "Corious Slaerin: My dear playerName, you must have some fantastic will power! Few things taste as good as the blood of one's enemy.",
...
TurnInItem(mySession, items.WARM_HEART, 1)
    ...
    npcDialogue = "Charlik Novandear's warm heart... I know you desire it for yourself, but do you have the strength to give it over to me?"
    diagOptions = { "Yes, it is difficult, but I think can give it to you.", "I wish to keep it for myself. Yes, I claim it as mine!" }
end
else
npcDialogue = "Corious Slaerin: If your will is too weak I shall just  make you my next ritual sacrifice! Return to me with Charlik Novandear's warm heart and I will consider forgiving you."
end
...
npcDialogue = "Corious Slaerin: If your will is too weak I shall just  make you my next ritual sacrifice! I need lantern oil to restock my supplies. Merchant Landi has some  for sale. Bring some to me and you will be rewarded."
elseif (choice:find("lantern")) then
multiDialogue = { "Corious Slaerin: Of course not, but we can't go parading illegal substances down the streets, now can we?",
...
multiDialogue = { "Corious Slaerin: You will be much more tired after I have buried you alive in the grave I have already had prepared for you behind this building. Perhaps you would like to reconsider?"
 } 
elseif (choice:find("darkness")) then
multiDialogue = { "Corious Slaerin: Take this bag of coins to Agent Wilkenson. He is on the docks. Complete any tasks that he may have for you and then return to me.",
...
multiDialogue = { "Corious Slaerin: While you may be a talented necromancer, I can quite easily tell when you are just stuffing my ears with nonsense. For each lie, I shall cause one of your toes to turn undead."
 } 
elseif (choice:find("Louhmanta")) then
multiDialogue = { "Corious Slaerin: The Mark of Louhmanta! This has been missing since my colleague went missing recently. It seems you have thwarted a plot against the House Slaerin.",
...
multiDialogue = { "Corious Slaerin: Dust, playerName. That is all you will be if you do not heed my commands. Dust."
 } 
elseif (choice:find("ready")) then
multiDialogue = { "Corious Slaerin: I am looking at your armor and I believe you need an upgrade. You need something that could amplify your abilities while offering protection.",
...
npcDialogue ="Corious Slaerin: I have nothing to say to you at the moment. Perhaps check back when you are stronger!"
end
...
npcDialogue = "Corious Slaerin: You must preside over the darkness, or it will preside over you! You must learn to become it's master! I'll need Poacher's Leggings from Tailor Weynia to upgrade your armor."
elseif (choice:find("Poacher\'s")) then
multiDialogue = { "Corious Slaerin: It seems like so long ago that I sent you away that I'd lost track of you, playerName.",
...
multiDialogue = { "Corious Slaerin: One thing that will never end are the corrupted hearts of the world, playerName. Find peace in knowing that eventually, you will return to the darkness that will cover the world for eternity."
 } 
elseif (choice:find("am")) then
multiDialogue = { "Corious Slaerin: You have done well for yourself. I expected nothing less as my assistant. Soon, you will grow too strong for me to control, but I have one final mission for you to complete.",
...
npcDialogue ="Corious Slaerin: I have something very important coming up for you. Please check back with me later."
end
...
npcDialogue = "Corious Slaerin: Time is running out. You must complete this mission. Go speak to Telina the Dark Witch."
elseif (choice:find("Telina")) then
multiDialogue = { "Corious Slaerin: Oh my...That is very interesting. She...is going to... Nevermind that.",
    ...
    "Corious Slaerin: As payment for your services, you've earned a set of rewards. The first is a Blood Gale Scroll, which drains your enemy's health and gives it to you. It comes with a Magic Sickle.",
    "Corious Slaerin: I also reward you with this Power Gale Scroll, which drains your enemy's power and gives it to you. It comes with a Magic Totem.",
"You have given away a note from Telina.",
"You have received a Blood Gale Scroll.",
"You have received a Magic Sickle.",
"You have received a Power Gale Scroll.",
"You have received a Magic Totem.",
    "You have finished a quest!",
...
GrantItem(mySession, items.MAGIC_SICKLE, 1)
GrantItem(mySession, items.POWER_GALE, 1)
GrantItem(mySession, items.MAGIC_TOTEM, 1)
else
