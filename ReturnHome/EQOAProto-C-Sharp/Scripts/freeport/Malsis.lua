...
npcDialogue = "Malsis: I will need an item to get started. You will need the iron ring from Merchant Yulia, then return to me."
...
CompleteQuest(mySession, 100101, quests[100101][1].xp)
else
...
npcDialogue = "Malsis: And just what have you been doing all this time? I'll need you to tend to my tasks if you expect any further instruction!"
...
CompleteQuest(mySession, 100102, quests[100102][3].xp)
else
