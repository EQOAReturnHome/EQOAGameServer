...
multiDialogue = { "Telina the Dark Witch: This is it. This is the treasure that my heart has long desired. I will now have the means to defeat my true enemy. His name is...Oh, nevermind that.",
    "Telina the Dark Witch: You have served me well. I herby release you from my watchful eye. For now, anyway. I wont forget that charming face though.",
...
npcDialogue = "Telina the Dark Witch: Time is running out. You must complete this mission. Go find the treasure."
        ...
        npcDialogue =
"Telina the Dark Witch: Now that you have seen me, my watchful eye will be able to see you, wherever you go, whatever you do, for as long as I wish it. You will have to fulfil my task to be freed of my watchful eye."
    end
------
